...
import keyboardLayout_R from '../data/layout/Hybrid English.json';
import keyboardLayout_L from '../data/layout/Hybrid English_L.json';
...
const OnekeyHybridEn = () => {
  ...
  useEffect(() => {
    const savedLayout = localStorage.getItem('selectedLayout');
    if (savedLayout === 'left') {
      setKeyboard(keyboardLayout_L);
    } else {
      setKeyboard(keyboardLayout_R);
    }
  }, []);
