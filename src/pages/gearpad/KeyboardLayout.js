...
import English from '../../data/layout/gearpad/Gearpad English.json';
import Korean from '../../data/layout/gearpad/Gearpad Korean.json';
...
const KeyboardLayout = ({ layout }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mb-16 relative" style={{ width: '350px', height: '400px' }}>
